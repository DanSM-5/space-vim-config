...
let s:fzf_bind_options = ['--bind', 'cctrl-l:change-preview-window(down|hidden|),trl-/:change-preview-window(down|hidden|),alt-up:preview-page-up,alt-down:preview-page-down']
